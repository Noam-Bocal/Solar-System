...
namespace master
{
    public partial class SelectByGenderAndYear : System.Web.UI.Page
    {
        public string st = "";
        public string msg = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sqlSelect = "SELECT * FROM " + tableName + " WHERE gender='Male' AND YearBorn BETWEEN 2004 AND 2010";

                DataTable table = Helper.ExecuteDataTable(fileName, sqlSelect);

                int length = table.Rows.Count;
                if (length == 0)
                    msg = "No male users born between 2004 and 2010 were found";
                else
                {
                    st += "<tr>";
                    st += "<th>User Name</th>";
